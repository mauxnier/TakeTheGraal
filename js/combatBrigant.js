...
function preload () {									//fonction qui permet de pré-charger les sons et images qui seront utiliser 
	imgjoueur_1 = loadImage ("https://killianmonnier.github.io/TakeTheGraal/img/fight/mage.png");		//on rentre l'image qui sera dans le sprite du joueur 1 dans la variable imgjoueur_1
	imgennemi_1 = loadImage ("https://killianmonnier.github.io/TakeTheGraal/img/fight/brigant.png");		//on rentre l'image qui sera dans le sprite de l'ennemi_1 dans la variable imgennemi_1
	imgsort_a = loadImage ("https://killianmonnier.github.io/TakeTheGraal/img/fight/feu.png");			//on rentre l'image qui sera dans le sprite du sort du joueur_1
	imgfond = loadImage ("https://killianmonnier.github.io/TakeTheGraal/img/fight/salleSansGraal.png");	//on rentre l'image de fond
}
...
function ennemi_1_attaque () {					//on défini la fonction ennemi_1_attaque
	ennemi_1.setSpeed (7, dir_ennemi_1);		//on donne une vitesse et une direction à l'ennemi_1 
...
function mort () {				//on défini la fonction mort
	...
	if (test == true) {
		alert ("Après un combat acharné vous avez réussi à tuer l'ennemi, malheureusement le Graal n'est pas là ... ");
		test = false;
	}
