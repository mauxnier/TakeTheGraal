...
function preload () {									//fonction qui permet de pré-charger les sons et images qui seront utiliser 
	...
	imgennemi_1 = loadImage ("../img/fight/brigant.png");		//on rentre l'image qui sera dans le sprite de l'ennemi_1 dans la variable imgennemi_1
	imgsort_a = loadImage ("../img/fight/feu.png");			//on rentre l'image qui sera dans le sprite du sort du joueur_1
	imgfond = loadImage ("../img/fight/salleSansGraal.png");	//on rentre l'image de fond
}
