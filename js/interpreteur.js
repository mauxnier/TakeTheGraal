...
function executerLigne(ligne){ // * interpréteur du code du fichier deroulement (var deroulement) * //
	...
	if (commande == 'fond'){ // *** fait apparaître un fond *** //
		...
		mode = "chargement";
		loadImage("https://paraceltus.github.io/TakeTheGraal/img/fond/" + fichier, function(img){ imageFond = img; mode = "deroulement"; }); // https://p5js.org/reference/#/p5/loadImage : appelée quand l'image est chargée
	}
		...
		mode = "chargement";
		loadImage("https://paraceltus.github.io/TakeTheGraal/img/perso/" + fichier, function(img){ // https://p5js.org/reference/#/p5/loadImage : appelée quand l'image est chargée
