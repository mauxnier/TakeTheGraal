...
function executerLigne(ligne){ // * interpréteur du code du fichier deroulement (var deroulement) * //
	...
	if (commande == 'fond'){ // *** fait apparaître un fond *** //
		...
		mode = "chargement";
		loadImage("../img/fond/" + fichier, function(img){ imageFond = img; mode = "deroulement"; }); // https://p5js.org/reference/#/p5/loadImage : appelée quand l'image est chargée
	}
		...
		mode = "chargement";
		loadImage("../img/perso/" + fichier, function(img){ // https://p5js.org/reference/#/p5/loadImage : appelée quand l'image est chargée
		...
		document.location = '../' + arguments[0] + '.html';
	}
